...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        if not message.startswith(magic_word):
        ...
        elif isinstance(self.obj, VendingMachine):
            if magic_word+'restock' in message:
                return self.obj.restock(args[0])
            elif magic_word+'deposit' in message:
                return self.obj.deposit(args[0])
            elif magic_word+'vend' in message:
            ...
            if not message.startswith(magic_word):
                return 'You must learn to say please first.'
            if magic_word+'ask' in message:
                return self.obj.ask(args[0], args[1])
            else:
                message = message[7:]
                return 'Thanks for asking, but I know not how to '+message+'.'
