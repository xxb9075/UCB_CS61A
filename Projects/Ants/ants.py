...
class Ant(Insect):
    ...
    food_cost = 0
    blocks_path = True  # Default path is not blocked, but it will be blocked if a NinjaAnt is instantiated
    container = False
...
class HarvesterAnt(Ant):
    ...
    name = 'Harvester'
    implemented = True
    food_cost = 2  # Override the food cost of HarvesterAnt
...
class ThrowerAnt(Ant):
    ...
    implemented = True
    damage = 1
    food_cost = 3  # Override the food cost of ThrowerAnt
    min_range = 0
    max_range = float('inf')
    ...
    def nearest_bee(self, hive):
        ...
        def nearest_bee_helper(place, hive):
            ...
            if place is hive or moved_steps > self.max_range:
                return None
            elif moved_steps < self.min_range:
...
def apply_effect(effect, bee, duration):
    ...
    bee.action = action    # END Problem EC
